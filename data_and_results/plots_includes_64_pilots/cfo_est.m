...
switch plotflag
    ...
    ylab=ylabel('NMSE of channel estimate (dB)');
end
hold on;
...
switch plotflag
    ...
    h_legend=legend([h2 h1],'$$N_p=32, \Delta f_c=93.75 \,\mathrm{KHz}$$','$$N_p=64, \Delta f_c=109.375\,\mathrm{KHz}$$');
    case 2
    h_legend=legend([h1 h2],'$$N_p=64, \Delta f_c=109.375\,\mathrm{KHz}$$', '$$N_p=32, \Delta f_c=93.75 \,\mathrm{KHz}$$');
    case 3
    h_legend=legend([h2 h1],'$$N_p=32, \Delta f_c=93.75 \,\mathrm{KHz}$$','$$N_p=64, \Delta f_c=109.375\,\mathrm{KHz}$$');
end
